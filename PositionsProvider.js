...
PositionProvider.prototype.getPositions = function(onlyInternal, callback) {
    if(onlyInternal) {
        Position.find({internal: false}, function(err, positions) {
...
PositionProvider.prototype.Add = function(p, callback) {
    ...
    pos.internal = p.internal === undefined ? false : true;
